<template>
	<view class="bodyMain flex-end">
		<view class="centent">
			...
			<view class="loginFoot flex-space-between">
				<u-button hover-class="none" @click="login" size="medium" plain class="login  m-btn">登录</u-button>
				<view :class="['flex-start regBtn', { isAndroid: isAndroid }]">
					<text>没有账号，现在</text>
					<text class="active" @click="navigateTo('register')">注册！</text>
				</view>
			</view>
		</view>
	</view>
